...
class PageController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $dataTypeContent = DB::table('posts')->where('id', $id)->first();
//         dd($dataTypeContent->id);

        
        $view = "vendor.voyager.posts.read";
        

        return view($view, ['dataTypeContent' =>$dataTypeContent]);
    }
