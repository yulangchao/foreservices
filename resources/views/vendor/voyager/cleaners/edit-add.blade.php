...
<script>
    function initAutocomplete() {
        $('input[name="address"]').attr('id','c-address');
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCaG8JNWl68rUI9O-5ngoDZlyVh9Qa8yjk&libraries=places&language=en&callback=initAutocomplete"
    async defer></script>
@stop
